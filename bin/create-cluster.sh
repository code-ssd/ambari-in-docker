...
docker run -d --privileged --name amb-server   --network ambari_net --ip 172.18.0.2 -it  dss/ambari:2.7.6.3
docker run -d --privileged --name amb1         --network ambari_net --ip 172.18.0.3 -it  dss/ambari:2.7.6.3
docker run -d --privileged --name amb2         --network ambari_net --ip 172.18.0.4 -it  dss/ambari:2.7.6.3
